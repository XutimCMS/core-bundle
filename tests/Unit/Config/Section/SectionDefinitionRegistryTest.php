...
namespace Xutim\CoreBundle\Tests\Unit\Config\Section;
...
final class SectionDefinitionRegistryTest extends TestCase
{
    public function testLookupByCode(): void
    {
        ...
        $registry = new SectionDefinitionRegistry([$pagePreview, $hero]);
    ...
    {
        $registry = new SectionDefinitionRegistry([$this->makeDefinition('page-preview', 'PP')]);
    ...
    public function testAllReturnsIndexedByCode(): void
    {
        ...
        $registry = new SectionDefinitionRegistry([$a, $b]);
    ...
    public function testDuplicateCodeThrows(): void
    {
        ...
        new SectionDefinitionRegistry([$first, $second]);
    }
     ...
     */
    private function makeDefinition(string $code, string $name, array $fields = []): SectionDefinition
    {
        return new class ($code, $name, $fields) implements SectionDefinition {
            /**
             * @param array<string, BlockItemOption> $fields
             */
