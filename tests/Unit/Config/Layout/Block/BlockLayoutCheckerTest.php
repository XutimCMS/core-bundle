...
class BlockLayoutCheckerTest extends TestCase
{
    ...
    public function configOptionsProvider(): array
    {
        ...
        $linkItem = new BlockItem($block, null, null, null, null, null, 'link');
        $linkItem2 = new BlockItem($block, null, null, null, null, null, 'link2');
        $linkItem3 = new BlockItem($block, null, null, null, null, null, 'link3');
        $coordItem = new BlockItem($block, null, null, null, null, null, null, null, null, 1.3, 2.4);
        $coordItem2 = new BlockItem($block, null, null, null, null, null, null, null, null, 5.3, 5.4);


        $block2 = new Block('code', 'name', 'desc', null, 'layout');
        $snippetItem = new BlockItem($block2, null, null, null, new Snippet('code'));
        $snippetItem = new BlockItem($block2, null, null, null, new Snippet('code'));
        $imageItem = new BlockItem($block2, null, null, new File(Uuid::v4(), 'name', 'alt', 'en', 'sldkfsdf.jpg', 'jpg', 'reference'));
