...
/**
 * Returns the inline form HTML for editing a xutimSection block's values.
 ...
 * wrapper via an AJAX fetch by the xutimSection tool.
 */
class EditXutimSectionFormAction extends AbstractController
{
    ...
    public function __invoke(Request $request, string $code): Response
    {
        ...
        $form = $this->createForm(SectionFormType::class, new LayoutValuesDto($initialValues), [
