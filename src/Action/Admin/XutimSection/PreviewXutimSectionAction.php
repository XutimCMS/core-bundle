 ...
 * xutimSection output for the current values. Used as the `srcdoc`
 * of an iframe inside the editor.js xutim-section tool so content
 ...
 */
class PreviewXutimSectionAction extends AbstractController
{
    ...
    public function __invoke(Request $request, string $code): Response
    {
        ...
        $fragmentData = [
            'sectionCode' => $definition->getCode(),
            'values' => $values,
        ];

        return $this->render('@XutimCore/admin/xutim_section/preview_wrapper.html.twig', [
