...
class DiscardDraftAction extends AbstractController
{
    ...
    public function __invoke(Request $request, string $draftId): Response
    {
        ...
        $this->commandBus->dispatch(new DiscardContentDraftCommand(
            $draft->getId(),
            $user->getUserIdentifier(),
        ));

        $this->addFlash('success', 'Draft discarded successfully.');
