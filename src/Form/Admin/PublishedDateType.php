...
/**
 * @template-extends AbstractType<array{publishedAt: null|\DateTimeImmutable, applyToAll?: bool}>
 */
class PublishedDateType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        if ($options['bulk_count'] > 1) {
            $builder->add('applyToAll', CheckboxType::class, [
                'label' => new TranslatableMessage('Apply to all %count% translations', ['%count%' => $options['bulk_count']], 'admin'),
                'required' => false,
            ]);
        }
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        ...
        $resolver->setAllowedTypes('bulk_count', 'int');
    }
}
