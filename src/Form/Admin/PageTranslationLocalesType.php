...
/**
 * @template-extends AbstractType<PageTranslationLocalesDto>
 * @template-implements DataMapperInterface<PageTranslationLocalesDto>
 */
class PageTranslationLocalesType extends AbstractType implements DataMapperInterface
{
    ...
    public function mapDataToForms(mixed $viewData, Traversable $forms): void
    {
        ...
        if (!$viewData instanceof PageTranslationLocalesDto) {
            throw new UnexpectedTypeException($viewData, PageTranslationLocalesDto::class);
        }
    ...
    public function mapFormsToData(Traversable $forms, mixed &$viewData): void
    {
        ...
        $viewData = new PageTranslationLocalesDto($allTranslationLocales, $translationLocales);
    }
}
