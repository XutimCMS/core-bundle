...
final readonly class ImageSectionFieldProvider implements SectionFieldProviderInterface
{
    ...
    public function buildField(
        ...
        $builder->add($fieldName, EntityType::class, [
            ...
            'placeholder' => new TranslatableMessage('select image', [], 'admin'),
            'required' => false,
            'block_prefix' => 'xutim_section_image',
