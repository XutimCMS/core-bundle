...
final readonly class CollectionSectionFieldProvider implements SectionFieldProviderInterface
{
    ...
    public function buildField(
        ...
        if (!$option instanceof BlockItemOptionCollection) {
            throw new \LogicException('CollectionSectionFieldProvider requires BlockItemOptionCollection');
        }

        $builder->add($fieldName, CollectionType::class, [
            'entry_type' => SectionCollectionEntryType::class,
            'entry_options' => [
            ...
            'block_prefix' => 'xutim_section_collection',
        ]);
    }
