...
{
    protected static string $defaultName = 'app:user:create';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $command = new CreateUserCommand($email, $name, $password, $roles, [], User::COMMAND_USER);
    ...
    protected function interact(InputInterface $input, OutputInterface $output): void
    {
        ...
        $email = $io->ask('Email', null, function (string $answer) use ($userRepository) {
            ...
            if ($userRepository->findOneBy(['email' => $answer]) !== null) {
        ...
        $name = $io->ask('Name', null, function (string $answer) use ($userRepository) {
            ...
            if ($userRepository->findOneBy(['name' => $answer]) !== null) {
