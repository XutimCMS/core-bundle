...
/**
 * Walks a xutimSection `values` blob and eager-loads UUID reference
 ...
 */
final readonly class XutimSectionValueResolver
{
     ...
     */
    public function resolve(SectionDefinition $definition, array $storedValues): array
    {
        $resolved = [];
